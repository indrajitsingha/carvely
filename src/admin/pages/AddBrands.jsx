...
const AddBrands = () => {
    ...
    const RegisterBrand = async (input,BrandLogo) => {
        ...
        const imageRef = ref(fireStorage, `uploads/BrandLogo/${uuidv4()}-${BrandLogo.name}`)
        const uploadImg = await uploadBytes(imageRef, BrandLogo);

        await addDoc(collection(fireStoreDb, 'Brands'), {
            id: uuidv4(),
            Brand: input,
            BrandLogo: uploadImg.ref.fullPath,
            SuperAdmin: user,
        })
    }
    ...
    return (
        <div className='w-[100%] h-auto flex justify-center items-center flex-col lg:flex-row mb-11 mt-11'>
            <div className=" h-auto lg:min-h-screen  pt-6 flex flex-col justify-center w-[90%] lg:w-[50%] mb-11 lg:m-0">
                <div className="relative py-1 sm:max-w-xl sm:mx-auto lg:mb-[15%]">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-yellow-300 to-orange-400 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
                    </div>
                    <div className="relative px-4 py-4 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                        <div className="max-w-md mx-auto">
                            <div>
                                <h1 className="text-2xl font-semibold">Add New Brands </h1>
                            </div>
            ...
            <section className="antialiased  text-gray-600 h-auto lg:h-screen   w-[80%] lg:w-[50%] " >
                <div className="flex flex-col justify-center h-full">

                    <div className="w-[100%] lg:w-[500px] bg-white shadow-lg rounded-sm border border-gray-200">
                        <header className="px-5 py-4 border-b border-gray-100">
                        <div className='flex justify-between items-center'>
                            <h2 className="text-[25px] text-gray-800 bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text font-bold">Brands List</h2>
                        ...
                        <div className="p-3">
                            ...
                            <div className='flex justify-evenly items-center flex-row text-white border-b-2 border-teal-200 bg-gradient-to-r from-orange-400 to-blue-500 p-2'>
                            ...
                            <div className="overflow-x-auto min-h-[100px] w-[100%] lg:w-[400px] pl-6">
                                <div>
                                    {
                                        Brand && Brand.map((x, index) => {
                                            return (

                                               <BrandCard x={x.data()} index={index} brandId={x.id} reRender={reRender} key={index}/>
