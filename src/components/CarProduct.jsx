...
const CarProduct = () => {
  return (
    <div className="mx-auto max-w-md overflow-hidden rounded-lg bg-white shadow sm:w-[25%] mt-5">
  <img
  ...
  <div className="p-4">
    ...
    <h3 className="text-xl font-medium text-gray-900">Hyundai Verna </h3>
    <h3 className="text-xl font-medium text-gray-900">Rs: 9.64 - 15.72 Lakh* </h3>
