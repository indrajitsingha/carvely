...
<section className="text-gray-700 body-font">
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover object-center rounded" alt="hero" src="https://images.unsplash.com/photo-1494976388531-d1058494cdd8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"/>
    </div>
  </div>
</section>
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="p-4 md:w-1/6">
        <div className="flex rounded-lg h-[25vh] bg-gray-100 p-8 flex-col">
      ...
      <div className="p-4 md:w-1/6">
        <div className="flex rounded-lg h-[25vh] bg-gray-100 p-8 flex-col">
          ...
          <div className="flex-grow">
            <p className="leading-relaxed text-center text-xl font-bold">5</p>
      ...
      <div className="p-4 md:w-1/6">
        <div className="flex rounded-lg h-[25vh] bg-gray-100 p-8 flex-col">
          <div className="flex flex-col justify-center items-center mb-2">
            <div className="w-10 h-10  inline-flex items-center justify-center  text-white flex-shrink-0">
              <img src="https://www.svgrepo.com/show/396544/fuel-pump.svg" alt="" />
            </div>
            <h2 className="text-gray-900 text-lg title-font font-medium">Fuel</h2>
          </div>
          <div className="flex-grow">
            <p className="leading-relaxed text-center text-xl font-bold">Petrol/CNG</p>
...
<div className="container px-5 py-5 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">ROOF PARTY POLAROID</h2>
      <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900">Specification of Maruti Swift</h1>
    </div>
    </div>
 <div className="flex    sm:text-xl w-[100%] flex-wrap  font-semibold  mb-5 justify-center flex-row items-center border-separate border-spacing-2">
<div className=" sm:w-[70%] bg-gray-100 compare  w-[100%]  flex justify-around items-center m-2">
 <div className=" sm:w-[30%]  ">
 <table className='sm:w-[100%]'>
 <tr className=' border-b border-gray-300   ' >
        <td className='p-5 p'>ARAI Mileage</td>
        <td>23.76 kmpl</td> 
    </tr> 
    <tr className=' border-b border-gray-300 ' >
